...
def calculate_price(doc):
    ...
    peak_factor = (
        1.5 if doc["start_date"].hour in {
            9, 10, 19, 20, 23, 0, 1, 2, 3, 4, 5} else 1
    )
...
if __name__ == "__main__":
    ...
    amc.admin.command(
        {"shardCollection": "london.taxi_rides", "key": {"_id": "hashed"}})
    Parallel(N_JOBS, backend="threading")(
        delayed(amc.london.taxi_rides.insert_many)(x) for x in batches)
